    ...
    <div id="register" class="form-container">
        <form method="GET" autocomplete="on" action="{{ url('/create_employee') }}">
            ...
            <div class="input-row">
                ...
                <div class="input-group">
                    <input id="department" name="department" type="text" required autofocus autocomplete="department  " class="input" />
                    <label for="department" class="placeholder" data-icon="u">Department  </label>
                </div>

                <div class="input-group">
                    <input id="position" name="position" type="text" required autofocus autocomplete="position   " class="input" />
                    <label for="position" class="placeholder" data-icon="u">Position</label>
                </div>

                <div class="input-group">
                    <input id="account_number" name="account_number" type="text" required autofocus autocomplete="account_number    " class="input" />
