...
<body>
    ...
    <div id="register" class="form-container">
        <form method="POST" autocomplete="on" action="{{ url('/createproject') }}">
            @csrf
            ...
            <div class="input-row">
                ...
                <div class="input-group">
                    <input id="description" name="description" type="text" required autofocus autocomplete="description " class="input" />
                    <label for="description" class="placeholder" data-icon="u">Description </label>
                </div>
                

                <div class="input-group">
                    <input id="duration" name="duration" type="text" required autofocus autocomplete="duration" class="input" />
                    <label for="duration" class="placeholder" data-icon="u">Duration </label>
                </div>

                <div class="input-group">
                    <input id="cost" name="cost" type="text" required autofocus autocomplete="cost" class="input" />
